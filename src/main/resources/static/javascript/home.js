...
//Update note and Get note by noteId
...
//Helper function that creates little note card for each item and appends it to the notes container
...
//Get notes method and logout button
getNotes(userId);
